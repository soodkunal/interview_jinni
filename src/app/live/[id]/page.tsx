...
  created_at: string
  session_id: number
  // Correct Type: Array of Session Objects
  mock_interview_sessions: { 
    recording_url: string | null
    questions_asked: any[] | null
  }[] | null 
  // Correct Type: Array of User Objects
  users: JoinedUserType[] | null 
}
...
    
    // FINAL FIX: Single-line query to bypass parser error
...
    } else {
      setSearchedRequest(requestData as PendingRequest);
    }
    setIsSearching(false)
  }
